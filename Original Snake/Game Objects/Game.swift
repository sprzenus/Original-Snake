...
class Game {
    ...
    private(set) var touchEventInvulnerabilityTimestamp: TimeInterval = 0 // to don't listen to touch events for a while when game is over
    ...
    func stop() {
        ...
        touchEventInvulnerabilityTimestamp = Date().timeIntervalSince1970 + 0.5
    }
